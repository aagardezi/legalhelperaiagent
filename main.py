...
import gemini20functioncourtlistener
...
market_query20_tool = types.Tool(
    function_declarations=[
        ...
        gemini20functioncourtlistener.search_case
    ],
)
...
PROMPT_ENHANCEMENT = """ You have a function tool that allows you to search for relevant cases, use that to first get the
content of the case and then answer the question. The tool requires a search string and a start date to start searching.
Craft a relevant search stirng based on the question and if a start date is not supplied, use a date from 1 year ago."""
